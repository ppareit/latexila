/* projects.c generated by valac 0.10.2, the Vala compiler
...
static void _lambda64_ (Block9Data* _data9_);
static void __lambda64__gtk_file_chooser_button_file_set (GtkFileChooserButton* _sender, gpointer self);
...
static void _lambda65_ (Block10Data* _data10_);
...
void projects_new_project (MainWindow* main_window) {
	...
	g_signal_connect_data (_data9_->file_chooser_button1, "file-set", (GCallback) __lambda64__gtk_file_chooser_button_file_set, block9_data_ref (_data9_), (GClosureNotify) block9_data_unref, 0);
...
void projects_manage_projects (MainWindow* main_window) {
	...
	gtk_widget_show_all ((GtkWidget*) content_area);
	g_signal_connect_data (edit_button, "clicked", (GCallback) __lambda65__gtk_button_clicked, block10_data_ref (_data10_), (GClosureNotify) block10_data_unref, 0);
	g_signal_connect_data (delete_button, "clicked", (GCallback) __lambda66__gtk_button_clicked, block10_data_ref (_data10_), (GClosureNotify) block10_data_unref, 0);
	g_signal_connect_data (clear_all_button, "clicked", (GCallback) __lambda67__gtk_button_clicked, block10_data_ref (_data10_), (GClosureNotify) block10_data_unref, 0);
