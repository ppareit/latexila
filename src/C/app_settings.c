/* app_settings.c generated by valac 0.10.2, the Vala compiler
...
static void _lambda80_ (GSettings* setting, const char* key, AppSettings* self);
static void __lambda80__g_settings_changed (GSettings* _sender, const char* key, gpointer self);
...
static gboolean _lambda91_ (AppSettings* self);
...
static void _lambda6_ (GSettings* setting, const char* key, AppSettings* self) {
	...
	if (val) {
		...
		_tmp0_ = g_settings_get_string (self->priv->editor, "editor-font");
	}
...
static void _lambda80_ (GSettings* setting, const char* key, AppSettings* self) {
	...
	app_settings_set_font (self, g_settings_get_string (setting, key));
}


static void __lambda80__g_settings_changed (GSettings* _sender, const char* key, gpointer self) {
	_lambda80_ (_sender, key, self);
}
...
static void _lambda81_ (GSettings* setting, const char* key, AppSettings* self) {
	g_return_if_fail (setting != NULL);
	g_return_if_fail (key != NULL);
	app_settings_set_system_font (self, g_settings_get_string (setting, key));
	if (g_settings_get_boolean (self->priv->editor, "use-default-font")) {
...
static void _lambda82_ (GSettings* setting, const char* key, AppSettings* self) {
	...
	g_return_if_fail (setting != NULL);
	g_return_if_fail (key != NULL);
	scheme_id = g_strdup (g_settings_get_string (setting, key));
...
static void _lambda90_ (GSettings* setting, const char* key, AppSettings* self) {
	...
	self->priv->timeout_id = g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, (guint) 1, __lambda91__gsource_func, g_object_ref (self), g_object_unref);
}
...
static void app_settings_initialize (AppSettings* self) {
	...
	app_settings_set_system_font (self, g_settings_get_string (self->priv->desktop_interface, "monospace-font-name"));
	g_signal_connect_object (self->priv->editor, "changed::use-default-font", (GCallback) __lambda6__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::editor-font", (GCallback) __lambda80__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->desktop_interface, "changed::monospace-font-name", (GCallback) __lambda81__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::scheme", (GCallback) __lambda82__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::tabs-size", (GCallback) __lambda83__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::insert-spaces", (GCallback) __lambda84__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::display-line-numbers", (GCallback) __lambda85__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::highlight-current-line", (GCallback) __lambda86__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::bracket-matching", (GCallback) __lambda87__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::auto-save", (GCallback) __lambda88__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::auto-save-interval", (GCallback) __lambda89__g_settings_changed, self, 0);
	g_signal_connect_object (self->priv->editor, "changed::nb-most-used-symbols", (GCallback) __lambda90__g_settings_changed, self, 0);
