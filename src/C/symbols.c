...
static void _lambda67_ (Block5Data* _data5_) {
	...
	if (_tmp7_) {
		...
		MostUsedSymbols* _tmp16_ = NULL;
		MostUsedSymbols* _tmp17_;
		...
		_tmp16_ = most_used_symbols_get_default ();
		_tmp17_ = _tmp16_;
		most_used_symbols_add_symbol (_tmp17_, id, latex_command, _tmp15_);
...
void symbols_reload_most_used_symbols (void) {
	gtk_list_store_clear (symbols_mus_store);
	{
		...
		_tmp0_ = most_used_symbols_get_default ();
		_tmp1_ = _tmp0_;
		_tmp2_ = most_used_symbols_iterator (_tmp1_);
		_tmp3_ = _tmp2_;
		_g_object_unref0 (_tmp1_);
		_mus_it = _tmp3_;
		while (TRUE) {
			...
			MostUsedSymbol mus;
			SymbolsSymbolInfo _tmp10_ = {0};
			SymbolsSymbolInfo _tmp11_ = {0};
			SymbolsSymbolInfo symbol;
			_tmp4_ = gee_iterator_next (_mus_it);
			if (!_tmp4_) {
				break;
			}
			_tmp5_ = gee_iterator_get (_mus_it);
			...
			mus = _tmp9_;
			symbols_get_symbol_info_from_most_used (&mus, &_tmp10_);
			_tmp11_ = _tmp10_;
			symbol = _tmp11_;
